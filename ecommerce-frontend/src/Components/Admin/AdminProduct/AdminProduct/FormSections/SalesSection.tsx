        ...
        <div className="font-gilroyRegular tracking-wider border rounded-md">
            ...
            {open && (
                <div className="px-4 pb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-500 mb-1">Sales UOM</label>
                        <select
                            name="salesUOM"
                            value={formData.salesUom || "pcs"}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-500 mb-1">
                            ...
                            {Number(formData.sellingPrice) > Number(formData.mrp) && (
                                <span className="text-red-500 text-xs ml-1">(Cannot be greater than MRP)</span>
                            )}
                        </label>
                        <input
                            type="number"
                            ...
                            onChange={handleChange}
                            className={`w-full px-3 py-2 border rounded-md text-sm ${Number(formData.sellingPrice) > Number(formData.mrp) ? "border-red-500" : ""
                                }`}
                            readOnly={mode === "view"}
                        />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-500 mb-1">Minimum Selling Price</label>
                        <input
                            type="number"
                            step="0.01"
