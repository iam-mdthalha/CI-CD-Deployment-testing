  ...
  return (
    <div className="font-gilroyRegular tracking-wider space-y-6">
      ...
      <div className="flex items-center justify-between py-4 border-t">
        ...
        <button className="px-4 py-2 border border-gray-300 rounded-md text-xs font-medium hover:bg-gray-50">
          Connect
        </button>
      </div>
      ...
      <div className="flex items-center justify-between py-4 border-t">
        ...
        <button className="px-4 py-2 border border-gray-300 rounded-md text-xs font-medium text-red-600 hover:bg-red-50">
          Disconnect
        </button>
      </div>
