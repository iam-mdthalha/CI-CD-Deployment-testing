...
export const BrandPromotionTable = ({
  promotions,
  onEdit,
  onView,
  onDelete,
          ...
          .map((brand) => (
            <tr key={brand.id} className="border-t">
              ...
              <td className="py-3 px-4 text-sm">
                {locationMap[brand.outlet] || brand.outlet}
              </td>
              <td className="py-3 px-4 text-sm">{brand.promotion}</td>
              <td className="py-3 px-4 text-sm">
                {brand.promotion_description}
              </td>
              <td className="py-3 px-4 text-sm">{brand.start_date_or_time}</td>
              <td className="py-3 px-4 text-sm">{brand.end_date_or_time}</td>
              <td className="py-3 px-4 text-sm">{brand.isActive}</td>
