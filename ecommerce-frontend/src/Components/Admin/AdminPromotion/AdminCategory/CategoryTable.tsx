...
interface CategoryPromotionTableProps {
  promotions: {
    id: number;
    outlet: string;
    promotion: string;
...
export const CategoryPromotionTable = ({
  promotions,
  onEdit,
  onView,
  onDelete,
          ...
          .map((promotion) => (
            <tr key={promotion.id} className="border-t">
              ...
              <td className="py-3 px-4 text-sm">
                {locationMap[promotion.outlet] || promotion.outlet}
              </td>
              <td className="py-3 px-4 text-sm">{promotion.promotion}</td>
              <td className="py-3 px-4 text-sm">
                {promotion.promotion_description}
              </td>
              <td className="py-3 px-4 text-sm">
                {promotion.start_date_or_time}
              </td>
              <td className="py-3 px-4 text-sm">
                {promotion.end_date_or_time}
              </td>
              <td className="py-3 px-4 text-sm">
                {promotion.isActive === "Y" ? "Yes" : "No"}
              </td>
