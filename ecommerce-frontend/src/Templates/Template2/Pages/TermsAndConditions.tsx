  ...
  return (
    <div className="min-h-screen font-montserrat max-w-4xl mx-auto px-6 py-12 text-gray-800">
      ...
      <div className="space-y-6 text-gray-700 text-justify leading-relaxed">
        ...
        <p>
          This website is operated by Caviaar Mode. Throughout the site, the
          terms "we", "us" and "our" refer to Caviaar Mode. Caviaar Mode offers
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 7 - OPTIONAL TOOLS</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 12 - PROHIBITED USES</h2>
        <p>
        ...
        <p>
          In no case shall Caviaar Mode, our directors, officers, employees,
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 14 - INDEMNIFICATION</h2>
        <p>
          You agree to indemnify, defend and hold harmless Caviaar Mode and our
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 15 - SEVERABILITY</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 16 - TERMINATION</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 18 - GOVERNING LAW</h2>
        <p>
        ...
        <p>
          ...
          or <br/>call us at{" "}
          <a href="tel:918056892910" className="text-blue-600 underline">
            +91 80568 92910
          </a>
          .
        </p>
        <p>
          ...
          <span className="font-medium">
            No 21 Mookanaginatru Street, Parangipettai, Cuddalore, Tamil Nadu
            608502
          </span>
          .
        </p>
