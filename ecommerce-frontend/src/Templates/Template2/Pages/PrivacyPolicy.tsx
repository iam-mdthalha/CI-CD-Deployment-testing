  ...
  return (
    <div className="min-h-screen font-montserrat max-w-4xl mx-auto px-6 py-12 text-gray-800">
      ...
      <div className="space-y-6 text-gray-700 text-justify leading-relaxed">
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 2 - CONSENT</h2>
        <h3 className="font-bold mt-4">How do you get my consent?</h3>
        <p>
        ...
        <h3 className="font-bold mt-4">How do I withdraw my consent?</h3>
        <p>
          ...
          <a
            href="mailto:admin@caviaarmode.com"
            className="text-blue-500 underline font-medium"
          >
            admin@caviaarmode.com
          </a>{" "}
          or mailing us at:{" "}
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 3 - DISCLOSURE</h2>
        <p>
          We may disclose your personal information if we are required by law to
          do so or if you violate our Terms of Service.
        </p>

        <h2 className="text-xl font-bold mt-8">SECTION 4 - PAYMENT</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 6 - SECURITY</h2>
        <p>
        ...
        <h2 className="text-xl font-bold mt-8">SECTION 7 - COOKIES</h2>
        <p>
          We use cookies to maintain session of your user. It is not used to
          personally identify you on other websites.
        </p>

        <h2 className="text-xl font-bold mt-8">SECTION 8 - AGE OF CONSENT</h2>
        <p>
