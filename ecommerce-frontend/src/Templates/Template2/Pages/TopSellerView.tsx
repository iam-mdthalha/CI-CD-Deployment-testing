...
const TopSellerView = () => {
  ...
  const currentProducts = useMemo(() => {
    ...
    let filtered = [...topSellingProducts.products];
  ...
  }, [topSellingProducts, filterCategories, sort]);

  const isLoading =
    selectedFilters.length > 0 ? filteredLoading : topSellingLoading;
  const totalProducts =
    selectedFilters.length > 0
      ? filteredProducts?.totalProducts || 0
      : topSellingProducts?.totalProducts || 0;
  ...
  return (
    <div className="min-h-screen font-montserrat tracking-widest container mx-auto px-4 py-8 bg-gray-50">
      <h1 className="text-2xl font-bold text-center mb-6">Top Sellers</h1>
