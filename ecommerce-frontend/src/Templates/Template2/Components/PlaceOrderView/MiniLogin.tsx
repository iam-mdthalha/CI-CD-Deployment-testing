...
const MiniLoginTab = ({ next }: Props) => {
  ...
  return (
    <div className="h-fit font-montserrat tracking-wider dark:bg-gray-900 flex items-center justify-center">
      {isSubmitting ? (
        ...
        <div className="w-full max-w-full bg-white dark:bg-gray-800 p-8 rounded-xl">
          ...
          >
            <div>
              <label
                htmlFor="mini-login-authenticationId"
                className="block text-sm font-medium text-gray-700 dark:text-gray-200"
              >
                Email or Mobile Number<span className="text-red-500">*</span>
              </label>
              <input
                id="mini-login-authenticationId"
                type="text"
