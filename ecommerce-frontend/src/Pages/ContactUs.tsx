...
const Template2ContactUs = lazy(
  () => import("Templates/Template2/Pages/ContactUs")
);
const Template4ContactUs = lazy(
  () => import("Templates/Template4/Pages/ContactUs")
);
  ...
  const chooseTemplate = (template: Templates) => {
    switch (template) {
      case Templates.TEMP2:
        return <Template2ContactUs />;
      case Templates.TEMP4:
        return <Template4ContactUs />;
      default:
