...
const Template2ReturnPolicyView = lazy(
  () => import("Templates/Template2/Pages/ReturnPolicyView")
);
const Template4ReturnPolicyView = lazy(
  () => import("Templates/Template4/Pages/ReturnPolicyView")
);
  ...
  const chooseTemplate = (template: Templates) => {
    switch (template) {
      case Templates.TEMP2:
        return <Template2ReturnPolicyView />;
      case Templates.TEMP4:
        return <Template4ReturnPolicyView />;
      default:
